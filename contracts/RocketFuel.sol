...
contract RocketTokenV2 is ERC20, Ownable {
    ...
    constructor() ERC20("Rocket Fuel", "RKFL") {
        ...
        rocketTokenAddress = address(0xdb83DB283183A98910442E1FDe77bAF8803BB037); // set as marketing wallet
        rocketGameAddress = address(0x30469c313972662f7E7Ac1fa49b0e4AD88786F15); // set as dev wallet
    ...
    function updateSellFees(
        ...
        sellFee = _sellFee;
        require(sellTotalFees <= 8, "Must keep fees at 25% or less");
    }
    ...
    function swapBack() private {
        ...
        if(sendTokensToGame) {
            ...
            //approve and send rocket tokens to the game
            rocketToken.approve(address(this), rktnForGame);
            rocketToken.transferFrom(address(this), rocketGameAddress, rktnForGame);

            //approve and send rocket fuel to the game
            _approve(address(this), address(uniswapV2Router),  rkflTokensForGame);
            _transferFrom(address(this), rocketGameAddress, rkflTokensForGame);
